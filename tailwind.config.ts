  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        treasure: "hsl(var(--treasure-gold))",
        explorer: "hsl(var(--explorer-badge))",
        map: "hsl(var(--map-brown))",
        sidebar: {
      ...
      boxShadow: {
        'treasure': '0 10px 40px -10px hsl(var(--primary) / 0.4)',
        'card': '0 4px 20px -2px hsl(var(--foreground) / 0.08)',
        'button': '0 4px 12px -2px hsl(var(--primary) / 0.3)',
      },
      keyframes: {
        "accordion-down": {
