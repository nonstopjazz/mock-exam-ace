...
const AdminDashboard = () => {
  ...
  const modules = [
    ...
    },
    {
      ...
      icon: Video,
      path: "/practice/admin/course-management",
      color: "bg-blue-500",
    },
    {
      title: "模擬考試管理",
      ...
      icon: FileText,
      path: "/practice/admin/exam-management",
      color: "bg-green-500",
    },
    {
      title: "單字複習管理",
    ...
    },
    {
      ...
      icon: Map,
      path: "/practice/admin/quest-map-management",
      color: "bg-orange-500",
    },
    {
      title: "寶石商店管理",
      ...
      icon: ShoppingBag,
      path: "/practice/admin/shop-management",
      color: "bg-pink-500",
    },
    {
      title: "成就管理",
      ...
      icon: Trophy,
      path: "/practice/admin/achievement-management",
      color: "bg-yellow-500",
    },
    {
      title: "標籤管理",
      ...
      icon: Tag,
      path: "/practice/admin/tag-management",
      color: "bg-red-500",
    },
  ];
