...
export default async function handler(req: any, res: any) {
  ...
  // The only legitimate caller is the Vercel Cron scheduler: this drives
  // the daily flashcard-review reminder for students with words due.
  ...
  // check was skipped entirely and anyone could trigger a flashcard
  // reminder broadcast to every subscriber, using service_role to read
  // push_subscriptions and user_stats with RLS bypassed.
  //
